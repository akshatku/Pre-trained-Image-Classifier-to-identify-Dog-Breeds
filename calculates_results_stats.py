...
def calculates_results_stats(results_dic):
    ...
    #Setting all counters to zero for later increments
    ...
    for key in results_dic:
        ...
        #Pet Image Label is of a dog--counts number of dog images
        
        if results_dic[key][3]==1:
            results_stats_dic['n_dogs_img']+=1
            
            #counting number of correct dog matches(and pet labels are dogs)
            if results_dic[key][4]==1:
                results_stats_dic['n_correct_dogs']+=1
                
        #Pet Image Label is NOT of a dog
    ...
    #Calculate run statistics below that utilize the counters above
    
    #Calculate number of total images
    
    results_stats_dic['n_images']=len(results_dic)
    
    #Calculating number of not-dogs images
    ...
    #Returning the dictionary created
